<template>
  <div class="min-h-screen bg-background text-foreground transition-colors duration-300">
    <!-- Navbar -->
    <nav class="sticky top-0 z-50 w-full border-b border-border/40 bg-background/60 backdrop-blur-xl">
      <div class="container mx-auto flex h-14 items-center justify-between px-6">
        <div class="flex items-center gap-3">
          <div class="flex h-8 w-8 items-center justify-center rounded-lg bg-gradient-to-br from-violet-600 to-indigo-600 shadow-md shadow-violet-500/20">
        ...
        <div class="flex items-center gap-2">
          <ClientOnly>
            ...
            >
              <Moon v-if="$colorMode.value !== 'dark'" class="h-4 w-4" />
