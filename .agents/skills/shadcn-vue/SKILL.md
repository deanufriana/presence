...
### Construction & Creation → [ui.md](../../rules/ui.md)

- **Mandatory shadcn-vue.** Every new component, feature, or page MUST be built using shadcn-vue components and patterns.
- **Compose, don't reinvent.** Build complex layouts by composing existing shadcn-vue primitives.

### Styling & Tailwind → [ui-styling.md](../../rules/ui-styling.md)
...
### Forms & Inputs → [ui-forms.md](../../rules/ui-forms.md)
...
### Component Structure → [ui-composition.md](../../rules/ui-composition.md)
...
### Use Components, Not Custom Markup → [ui-composition.md](../../rules/ui-composition.md)
...
### Icons → [ui-icons.md](../../rules/ui-icons.md)
...
- [ui-forms.md](../../rules/ui-forms.md) — FieldGroup, Field, InputGroup, ToggleGroup, FieldSet, validation states
- [ui-composition.md](../../rules/ui-composition.md) — Groups, overlays, Card, Tabs, Avatar, Alert, Empty, Toast, Separator, Skeleton, Badge, Button loading
- [ui-icons.md](../../rules/ui-icons.md) — data-icon, icon sizing, passing icons as objects
- [ui-styling.md](../../rules/ui-styling.md) — Semantic colors, variants, class, spacing, size, truncate, dark mode, cn(), z-index
