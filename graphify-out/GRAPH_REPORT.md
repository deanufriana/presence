# Graph Report - presence (2026-08-06)

## Corpus Check

- 182 files · ~172,663 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary

- 1054 nodes · 1577 edges · 107 communities (62 shown, 45 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 6 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness

- Built from commit: `f03a6397`
...
### Community 0 - "utils/reports.ts"

Cohesion: 0.18
Nodes (14): getAllMonthlySummaries(), getDailyReports(), getMonthlyActivityStatus(), getMonthlyReport(), getYearlyReport(), upsertDailyReport(), upsertMonthlyReport(), upsertYearlyReport() (+6 more)

### Community 1 - "utils/jira.ts"

Cohesion: 0.14
Nodes (13): useDocxExport(), useExcelExport(), useCalendarStore, JiraCache, JiraChildTask, MonthlyReportRow, SettingsData, JiraApiError (+5 more)
...
### Community 6 - "utils/gitlab.ts"

Cohesion: 0.15
Nodes (18): getGitLabCommitsByPeriod(), upsertGitLabCommit(), getMonthRange(), fetchGitLab(), getCommitRefs(), getGitLabCache(), getGitLabConfig(), getGitLabUser() (+10 more)
...
Cohesion: 0.12
Nodes (17): Buttons inside inputs use InputGroup + InputGroupAddon, code:vue (<FieldGroup>), code:html (<!-- Invalid. -->), code:html (<InputGroup>), code:js (<script setup lang="ts">), code:html (<div class="relative">), code:js (<script setup lang="ts">), code:js (<script setup lang="ts">) (+9 more)
...
Cohesion: 0.06
Nodes (25): emits, forwarded, props, delegatedProps, emits, forwarded, props, delegatedProps (+17 more)
...
Cohesion: 0.08
Nodes (18): delegatedProps, emits, forwarded, props, delegatedProps, forwardedProps, props, delegatedProps (+10 more)

### Community 21 - "Icons"

Cohesion: 0.25
Nodes (8): code:html (<button>), code:html (<button>), code:html (<button>), code:js (<script setup lang="ts">), Icons, Icons in Button use data-icon attribute, No sizing classes on icons inside components, Pass icons as component objects, not string keys
...
Cohesion: 0.11
Nodes (13): calendarStore, copiedRows, coreStore, dailyStore, {
dailyTable,
summarizingRows,
syncingRows,
summarizingAll,
...
syncing,
showConfirmSync,
}, dateObj, { exportToExcel, exporting }, hasScrolledToToday (+5 more)
...
Cohesion: 0.20
Nodes (14): getDb(), getJiraActivitiesByDates(), getJiraActivitiesByPeriod(), upsertJiraActivity(), getJiraExportData(), upsertJiraExportData(), deleteDailyReport(), getDailyActivitiesByDates() (+6 more)
...
Cohesion: 0.09
Nodes (18): ActivityItem, addInputRef, cancelAdding(), confirmAdd(), currentTexts, dailyStore, debouncedUpdate, DraggableEvent (+10 more)

### Community 38 - "cn"

Cohesion: 0.12
Nodes (12): props, props, props, props, content, props, props, props (+4 more)

### Community 39 - "report.ts"

Cohesion: 0.29
Nodes (10): CalendarCache, CalendarDay, CalendarEvent, GitLabEvent, Holiday, JiraEvent, JiraExportData, ReportResponse (+2 more)
...
### Community 41 - "core.ts"

Cohesion: 0.24
Nodes (9): { success }, { toasts }, ToastProps, toasts, useToast(), useCoreStore, useGitlabStore, useJiraStore (+1 more)

### Community 42 - "ActivityCalendar.vue"

Cohesion: 0.15
Nodes (9): { calendarBlanks, calendarDays }, calendarStore, coreStore, dailyStore, { pending: syncingAll, dateDisplay, selectedDate }, { syncingRows }, dailyStore, {
selectedDayForEntry,
manualActivityText,
manualHolidayName,
isManualHoliday,
...
### Community 45 - "YearlyReport.vue"

Cohesion: 0.14
Nodes (9): columns, coreStore, { exportBASTToExcel, exporting: exportingExcel }, { exportingDocx }, { isAiEnabled, selectedDate }, { success, error }, { yearlyRows, yearlyHighlights, summarizing, isLoading, currentYear }, yearlyStore (+1 more)
...
### Community 48 - "queries/calendar.ts"

Cohesion: 0.29
Nodes (11): deleteCalendarEventsByMonth(), deleteHolidayByDate(), getCalendarEventsByMonth(), getHolidaysByMonth(), insertCalendarEvent(), insertCalendarEvents(), upsertHoliday(), upsertManualHoliday() (+3 more)
...
### Community 57 - "textarea/index.ts"

Cohesion: 0.40
Nodes (3): emits, modelValue, props

### Community 58 - "CalendarGridRow.vue"

Cohesion: 0.50
Nodes (3): delegatedProps, forwardedProps, props

### Community 59 - "CalendarHeadCell.vue"

Cohesion: 0.50
Nodes (3): delegatedProps, forwardedProps, props

### Community 60 - "groupSubtasksWithAI"

Cohesion: 0.67
Nodes (3): groupSubtasksWithAI(), isActivityRelated(), getJiraGroupSubtasksPrompt()

## Knowledge Gaps

- **565 isolated node(s):** `coreStore`, `dailyStore`, `calendarStore`, `{ calendarBlanks, calendarDays }`, `{ syncingRows }` (+560 more)
...
- **Why does `cn()` connect `cn` to `utils/index.ts`, `SettingsModal.vue`, `DailyReportRow.vue`, `MonthPicker.vue`, `Tabs.vue`, `TooltipContent.vue`, `select/index.ts`, `dialog/index.ts`, `calendar/index.ts`, `FieldSeparator.vue`, `alert-dialog/index.ts`, `button/index.ts`, `FieldLabel.vue`, `textarea/index.ts`, `CalendarGridRow.vue`, `CalendarHeadCell.vue`, `alert/index.ts`?**
  _High betweenness centrality (0.056) - this node is a cross-community bridge._
- **Why does `getDb()` connect `getDb` to `utils/reports.ts`, `utils/gitlab.ts`, `report.ts`, `queries/calendar.ts`, `ai.ts`?**
...
- **Should `utils/jira.ts` be split into smaller, more focused modules?**
